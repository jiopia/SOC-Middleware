...
enum HMI_MSG_TYPE
{
    ...
    HMI_MSG_TYPE_ODO_CLEAN = 0x0D, //小计里程清零
    HMI_MSG_TYPE_ECU_CLEAN = 0x0E  //平均油耗清零
};
...
enum HMI_MGS_NAVI_ID
{
    ...
    HMI_MGS_NAVI_ID_CAST_SCREEN_REQUEST = 0x10, //投屏请求与退出(HMI->MW)
    HMI_MGS_NAVI_ID_CAST_SCREEN_RESPONSE = 0x11 //投屏应答(MW->HMI)
};

enum CastScreenRequestValue
{
    HMI_REQUEST_CAST_SCREEN = 0x01,
    HMI_QUIT_CAST_SCREEN = 0x02
};
